...
//        initColorTrackText()
//        initLetterSideBar()
//        Log.d("MainActivity", "onCreate btn_view.measuredHeight ==> " + text_view.measuredHeight.toString())
...
//        text_view.post {
//            Log.d("MainActivity", "post btn_view.measuredHeight ==> " + text_view.measuredHeight.toString())
//        }

        touch_view.setOnTouchListener { _, event ->
            Log.d("MainActivity", "setOnTouchListener ==> " + event.action);
            false
        }
    ...
    override fun onResume() {
        super.onResume()
        Log.d("MainActivity", "onResume btn_view.measuredHeight ==> " + text_view.measuredHeight.toString())
    }
